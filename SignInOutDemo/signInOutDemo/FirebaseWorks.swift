...
class FirebaseWorks{
    ...
    func signInFireBaseWithFB(completion: @escaping (_ result: Result) -> ()){
        ...
        //FB金鑰
        let fbCredential = FIRFacebookAuthProvider.credential(withAccessToken: fbAccessTokenString)
        firebaseSignInWithCredential(credential: fbCredential, completion: completion)
    }
    ...
    private func firebaseSignInWithCredential(credential: FIRAuthCredential,completion: @escaping (_ result: Result) -> ()){
